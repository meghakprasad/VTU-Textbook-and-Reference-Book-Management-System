   ...
   <html>
    ...
    <body>
        <div class="container">
            ...
            <section class="main">
                <div class="main-top">
                    <h1 style="color:black">Students Signed Up</h1><br>
                </div>
  <hr/>

<table border="5px" align="center" cellpadding="10px" background=""  style="color:white;">
  <tr>
    <th>USN</th>
    <th>NAME</th>
    <th>DEPARTMENT</th>
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  echo "<tr> <td>".$row['stu_id']."</td><td>".$row['stu_name']."</td><td>".$row['stu_dept']."</td><td>".$row['stu_email']."</td><td>".$row['stu_sem']."</td><td>".$row['password']."</td><td>".$row['stu_phone']."</td></tr>";
  
  
}
?>
</table>
<form action="studelete.php" method="post">
    <br>
